...
class PageController {
    ...
    // Ajustes a la vista
    var $tOpcion = 'Perfiles';  // Titulo de la vista
    ...
    function __construct() {
        ...
        try {
            ...
            global $usuLogOb, $p_perfiles, $res_pp, $si_del, $noenter;
            ...
            $Udao->ConPermisos($usuLogOb, $p_perfiles, 'c');
            ...
            if ($_GET['cmd'] == 'del') {
                ...
                // instancia existente
                $pE = $Udao->ConPermisos($usuLogOb, $p_perfiles, 'e');
