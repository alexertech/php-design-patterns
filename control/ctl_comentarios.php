...
class PageController {
    ...
    // Ajustes a la vista
    var $tOpcion = 'Comentario';  // Titulo de la vista
    ...
    function __construct() {
        ...
        try {
            ...
            global $usuLogOb, $p_comentarios, $res_pp, $si_del, $noenter;
            ...
            $Udao->ConPermisos($usuLogOb, $p_comentarios, 'c');
            ...
            if ($_GET['cmd'] == 'del') {
                ...
                // instancia existente
                $pE = $Udao->ConPermisos($usuLogOb, $p_comentarios, 'e');
    ...
    function parseForm(){
        ...
        $this->vo->cod_comentario = $_GET['cod'];
